    ...
    public partial class ListEmployee : Form
    {
        ...
        private async void Button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool sqlresult = await db.ExecSQLAsync("INSERT into Employees(FIO, DateOfBirth, id_Qualification, id_Position, Login, Password, id_Type) values('" + EmployeeFIO + "', '" + DataOfBirth + "', '" + QualificationID + "', '" + PositionID + "', '" + Login + "', '" + Password + "', '" + TypeID + "')");
            }
            RefreshGrid();
        }
        ...
        private async void Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool sqlresult = await db.ExecSQLAsync("UPDATE Employees set FIO ='" + EmployeeFIO + "', DateOfBirth = '" + DataOfBirth + "' ,id_Qualification = '" + QualificationID + "', id_Position = '" + PositionID + "', Login = '" + Login + "', Password = '" + Password + "', id_Type = '" + TypeID + "' where ID = '" + ID + "'");
            }
            RefreshGrid();
        }
        ...
        private async void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                bool sqlresult = await db.ExecSQLAsync("DELETE FROM Employees where id = '" + ID + "'");
            }
