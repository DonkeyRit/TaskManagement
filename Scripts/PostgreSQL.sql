...
insert into Tasks(Name, id_Complexity, Date_Delivery, id_TaskManager) values('Автоматизированные информационные системы управления', 1, '01-06-2019', 1),('Предназначение адаптивного матричного мультипликатора', 2, '05-05-2019', 1),('Адекватность и объективность моделирования информационной системы управления', 3, '19-04-2019', 1),
('Мониторинговый алгоритм состояния сети передачи данных', 4, '20-04-2019', 1),('Сущность и особенности алгоритма работы блока ввода и обработки данных', 1, '07-05-2019', 1), ('Оценка интенсивности трафика', 2, '10-05-2019', 1),('Оценка качества связи на основании принятия информационных сигналов', 3, '25-07-2019', 1),
('Особенности математического и программного обеспечения систем управления', 4,'07-06-2019', 1),('Оценка надежности системы с общей резервацией элементов', 1, '15-05-2019', 1), ('Характерные особенности моделирования систем передачи информации особой важности', 2, '01-08-2019', 1);
